 ...
 * RWC Base.
 *
 * This file adds the required CSS to the front end to the RWC Base Theme.
 *
 * @package RWC Base
...
add_action( 'wp_enqueue_scripts', 'rwc_base_css' );
/**
...
function rwc_base_css() {
	...
	if ( $logo ) {
		...
		$logo_max_width        = get_theme_mod( 'rwc_base_logo_width', 350 );
	...
	$css .= ( rwc_base_customizer_get_default_link_color() !== $color_link ) ? sprintf(
		'
	...
	$css .= ( rwc_base_customizer_get_default_accent_color() !== $color_accent ) ? sprintf(
		'
